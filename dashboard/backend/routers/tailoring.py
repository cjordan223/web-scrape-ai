...
ROUTES: list[tuple[str, str, str]] = [
    ...
    ("GET", "/api/packages/{slug}/download.zip", "package_download_zip"),
    ("DELETE", "/api/packages/{slug}", "package_delete"),
    ("POST", "/api/packages/{slug}/reject", "package_reject"),
    ("POST", "/api/packages/{slug}/dead", "package_permanently_reject"),
    ...
    ("GET", "/api/llm/providers", "llm_providers"),
    ("POST", "/api/llm/providers/key", "llm_set_provider_key"),
    ("POST", "/api/llm/providers/activate", "llm_activate_provider"),
    ("POST", "/api/llm/providers/test", "llm_test_provider"),
    ("GET", "/api/llm/infrastructure", "llm_infrastructure"),
    ("POST", "/api/llm/chat", "llm_chat"),
    ("GET", "/api/llm/catalog", "llm_catalog"),
    ("POST", "/api/llm/benchmark", "llm_benchmark"),
    ...
    ("GET", "/api/tailoring/qa/llm-review/reports/{batch_id}", "tailoring_qa_llm_review_report"),
