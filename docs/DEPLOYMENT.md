...
Default config is in `job_scraper/config.default.yaml`. Override with a user config:
...
SQLite at `~/.local/share/job_scraper/jobs.db`. Three tables:

| Table | Purpose |
|---|---|
| `seen_urls` | Dedup — every URL ever encountered |
| `results` | Passing jobs with full JD text + filter verdicts |
...
<dict>
    ...
    <array>
        <string>/Users/conner/Documents/SearXNG/venv/bin/python</string>
        <string>-m</string>
    ...
    <string>/Users/conner/Documents/SearXNG</string>
    <key>StartInterval</key>
    <integer>1800</integer>
    <key>StandardOutPath</key>
    <string>/Users/conner/.local/share/job_scraper/scrape.log</string>
...
<dict>
    ...
    <key>WorkingDirectory</key>
    <string>/Users/conner/Documents/SearXNG/dashboard</string>
    <key>RunAtLoad</key>
    <true/>
    <key>KeepAlive</key>
    <true/>
    <key>StandardOutPath</key>
    <string>/Users/conner/.local/share/job_scraper/dashboard.log</string>
    <key>StandardErrorPath</key>
    <string>/Users/conner/.local/share/job_scraper/dashboard.log</string>
</dict>
</plist>
