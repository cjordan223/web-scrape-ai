...
---
<!--
PURPOSE: Injected in analysis and resume strategy stages. Tells the LLM what themes to
         frame bullets around. Vignettes are the stories — this is the pattern behind them.
EDIT: Update bullet list items as your role profile evolves. Each item is a contribution
      pattern the LLM uses when writing rewrite angles and framing bullets.
